      ...
      <section className="container">
        <div className="grid md:grid-cols-3 py-5">
          ...
          <div className="py-8 px-4">
            ...
            <p className="text-sm">
              We provide quality car rental services to ensure your journey is
              comfortable and hassle-free. Choose us for reliable and affordable
